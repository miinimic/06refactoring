...
<form name="updateReview" method="post"	action="/updateReview.do?tranNo=${purchase.purchase.tranNo }">
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">후기 수정</td>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">후기</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<textarea rows="4" cols="50" name="review" placeholder="후기를 작성하세요."></textarea>
		</td>
	</tr>
</table>
